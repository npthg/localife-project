  ...
  return (
    <View style={{flex:1, backgroundColor: '#FCF6EE'}}>
      ...
      <View style={{marginTop: 20}}>
        <Text style={{fontSize: 25, fontWeight: 'bold', color: 'black', marginLeft: 15, marginBottom:5}}>Recently visited</Text>
        {doneAct.length > 0 ?
        <FlatList
          data={doneAct}
        ...
        />
        : <Text style={{alignSelf: 'center', fontSize: 12, color: 'lightgray', marginTop: 15}}>{user.username} did not travel anywhere. </Text>}
      </View>
